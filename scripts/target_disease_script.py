...
from otar_biocypher.ota import (
    ...
    HPONodeField, # started here
    DrugMechanismOfActionNodeField,
    DrugIndicationNodeField,
    # Contains repeated nodes from indication and moa
    # DrugPharmacovigilanceNodeField
    TargetBaselineExpressionNodeField,
    DepMapEssentialityNodeField
)
...
target_disease_node_fields = [
    ...
    #DrugMOA
    DrugMechanismOfActionNodeField.DRUG_CHEMBL_ID,
    DrugMechanismOfActionNodeField.ACTION_TYPE,
    #DrugIndication
    DrugIndicationNodeField.DRUG_CHEMBL_ID,
    DrugIndicationNodeField.DRUG_APPROVED_INDICATIONS,
    DrugIndicationNodeField.DRUG_INDICATION_COUNT,
    #Pharmacovigilance -> contains duplicated ndoes from indication and moa
    # DrugPharmacovigilanceNodeField.DRUG_CHEMBL_ID,
    # DrugPharmacovigilanceNodeField.CRITVAL,
    # DrugPharmacovigilanceNodeField.COUNT,
    # DrugPharmacovigilanceNodeField.EVENT,
    # DrugPharmacovigilanceNodeField.LLR,
    # DrugPharmacovigilanceNodeField.MEDDRA_CODE
    TargetBaselineExpressionNodeField.TARGET_GENE_ENSG,
    TargetBaselineExpressionNodeField.TISSUES,
    # depmap essentiality
    DepMapEssentialityNodeField.DEPMAP_SNEMBL_ID
]
